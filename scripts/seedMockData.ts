...
const recipesData = [
  {
    ...
    instructions: {
      ...
      ingredients: [
        { id: 101, name: 'Sourdough Bread', amount: 1, unit: 'slice', aisle: 'Bakery' },
        { id: 102, name: 'Avocado', amount: 0.5, unit: 'whole', aisle: 'Produce' },
        { id: 103, name: 'Egg', amount: 1, unit: 'large', aisle: 'Dairy' },
        { id: 104, name: 'Lemon Juice', amount: 1, unit: 'tsp', aisle: 'Produce' }
      ]
    }
  },
  {
    ...
    instructions: {
      ...
      ingredients: [
        { id: 201, name: 'Chicken Breast', amount: 150, unit: 'g', aisle: 'Meat' },
        { id: 202, name: 'Quinoa', amount: 0.5, unit: 'cup', aisle: 'Pasta and Rice' },
        { id: 203, name: 'Cucumber', amount: 0.5, unit: 'cup', aisle: 'Produce' },
        { id: 204, name: 'Cherry Tomatoes', amount: 5, unit: 'whole', aisle: 'Produce' }
      ]
    }
  },
  {
    ...
    instructions: {
      ...
      ingredients: [
        { id: 301, name: 'Salmon Fillet', amount: 180, unit: 'g', aisle: 'Seafood' },
        { id: 302, name: 'Asparagus', amount: 100, unit: 'g', aisle: 'Produce' },
        { id: 303, name: 'Olive Oil', amount: 1, unit: 'tbsp', aisle: 'Oil, Vinegar, Salad Dressing' },
        { id: 304, name: 'Lemon', amount: 0.5, unit: 'whole', aisle: 'Produce' }
      ]
    }
  },
  {
    ...
    instructions: {
      ...
      ingredients: [
        { id: 401, name: 'Frozen Berries', amount: 1, unit: 'cup', aisle: 'Frozen' },
        { id: 402, name: 'Banana', amount: 1, unit: 'whole', aisle: 'Produce' },
        { id: 403, name: 'Almond Milk', amount: 0.5, unit: 'cup', aisle: 'Beverages' },
  ...
  },
  {
    ...
    instructions: {
      ...
      ingredients: [
        { id: 501, name: 'Beef Flank Steak', amount: 150, unit: 'g', aisle: 'Meat' },
        { id: 502, name: 'Broccoli Florets', amount: 2, unit: 'cups', aisle: 'Produce' },
        { id: 503, name: 'Soy Sauce', amount: 2, unit: 'tbsp', aisle: 'Condiments' },
        { id: 504, name: 'Brown Rice', amount: 0.5, unit: 'cup', aisle: 'Pasta and Rice' }
      ]
    }
  },
  {
    ...
    instructions: {
      ...
      ingredients: [
        { id: 601, name: 'Greek Yogurt', amount: 200, unit: 'g', aisle: 'Dairy' },
        { id: 602, name: 'Honey', amount: 1, unit: 'tbsp', aisle: 'Baking' },
        { id: 603, name: 'Walnuts', amount: 15, unit: 'g', aisle: 'Snacks' },
        { id: 604, name: 'Blueberries', amount: 0.25, unit: 'cup', aisle: 'Produce' }
      ]
    }
  },
  {
    ...
    instructions: {
      ...
      ingredients: [
        { id: 701, name: 'Dried Lentils', amount: 0.5, unit: 'cup', aisle: 'Pasta and Rice' },
        { id: 702, name: 'Vegetable Broth', amount: 2, unit: 'cups', aisle: 'Canned and Jarred' },
        { id: 703, name: 'Carrot', amount: 1, unit: 'medium', aisle: 'Produce' },
        { id: 704, name: 'Onion', amount: 0.5, unit: 'medium', aisle: 'Produce' }
      ]
    }
  },
  {
    ...
    instructions: {
      ...
      ingredients: [
        { id: 801, name: 'Turkey Breast', amount: 100, unit: 'g', aisle: 'Meat' },
        { id: 802, name: 'Bacon', amount: 2, unit: 'strips', aisle: 'Meat' },
        { id: 803, name: 'Whole Wheat Bread', amount: 3, unit: 'slices', aisle: 'Bakery' },
        { id: 804, name: 'Tomato', amount: 2, unit: 'slices', aisle: 'Produce' }
      ]
    }
  },
  {
    ...
    instructions: {
      ...
      ingredients: [
        { id: 901, name: 'Spaghetti', amount: 100, unit: 'g', aisle: 'Pasta and Rice' },
        { id: 902, name: 'Zucchini', amount: 0.5, unit: 'whole', aisle: 'Produce' },
        { id: 903, name: 'Bell Pepper', amount: 0.5, unit: 'whole', aisle: 'Produce' },
        { id: 904, name: 'Parmesan Cheese', amount: 2, unit: 'tbsp', aisle: 'Dairy' }
      ]
    }
  },
  {
    ...
    instructions: {
      ...
      ingredients: [
        { id: 111, name: 'Rolled Oats', amount: 0.5, unit: 'cup', aisle: 'Cereal' },
        { id: 112, name: 'Apple', amount: 1, unit: 'medium', aisle: 'Produce' },
        { id: 113, name: 'Cinnamon', amount: 0.5, unit: 'tsp', aisle: 'Spices and Seasonings' },
        { id: 114, name: 'Maple Syrup', amount: 1, unit: 'tbsp', aisle: 'Condiments' }
      ]
    }
  },
  {
    ...
    instructions: {
      ...
      ingredients: [
        ...
        { id: 122, name: 'Corn Tortillas', amount: 3, unit: 'small', aisle: 'Bakery' },
        { id: 123, name: 'Cabbage Slaw', amount: 0.5, unit: 'cup', aisle: 'Produce' },
  ...
  },
  {
    ...
    instructions: {
      ...
      ingredients: [
        ...
        { id: 132, name: 'Fresh Spinach', amount: 1, unit: 'handful', aisle: 'Produce' },
  ...
  },
  {
    ...
    instructions: {
      ...
      ingredients: [
        { id: 141, name: 'Canned Tuna', amount: 1, unit: 'can', aisle: 'Canned and Jarred' },
        { id: 142, name: 'Whole Wheat Tortilla', amount: 1, unit: 'large', aisle: 'Bakery' },
        { id: 143, name: 'Celery', amount: 1, unit: 'stalk', aisle: 'Produce' },
        { id: 144, name: 'Mustard', amount: 1, unit: 'tsp', aisle: 'Condiments' }
      ]
    }
  },
  {
    ...
    instructions: {
      ...
      ingredients: [
        { id: 151, name: 'Arborio Rice', amount: 0.5, unit: 'cup', aisle: 'Pasta and Rice' },
        { id: 152, name: 'Mushrooms', amount: 150, unit: 'g', aisle: 'Produce' },
        { id: 153, name: 'Parmesan Cheese', amount: 3, unit: 'tbsp', aisle: 'Dairy' },
        { id: 154, name: 'Vegetable Broth', amount: 3, unit: 'cups', aisle: 'Canned and Jarred' }
      ]
    }
  },
  {
    ...
    instructions: {
      ...
      ingredients: [
        { id: 161, name: 'Chia Seeds', amount: 3, unit: 'tbsp', aisle: 'Health Foods' },
        { id: 162, name: 'Almond Milk', amount: 1, unit: 'cup', aisle: 'Beverages' },
        { id: 163, name: 'Mango', amount: 0.5, unit: 'cup', aisle: 'Produce' },
        { id: 164, name: 'Vanilla Extract', amount: 0.5, unit: 'tsp', aisle: 'Baking' }
      ]
    }
  }
];
